...
//       // Enhanced event handlers with proper state updates
//       socket.on('new-order', (newOrder) => {
//         console.log('🆕 New order via socket:', newOrder)
...
//       // In your socket setup in ReceptionDashboard
// socket.on('order-status-updated', (updatedOrder) => {
//   console.log('🔄 Order status updated via socket:', updatedOrder);
...
//       // New event for order updates from other sources
//       socket.on('order-updated', (updatedOrder) => {
//         console.log('📝 Order updated via socket:', updatedOrder)
...
//         console.log('🗑️ Order deleted via socket:', deletedOrderId)
        
//         setOrders(prev => {
//           const deletedOrder = prev.find(order => order._id === deletedOrderId)
//           const updatedOrders = prev.filter(order => order._id !== deletedOrderId)
//           calculateStatsFromOrders(updatedOrders)
          
//           if (deletedOrder) {
//             updateTableOrder(deletedOrder.tableNumber, null)
//           }
...
// In your ReceptionDashboard component, replace the socket setup with this:
